...
const Projects = () => {
  ...
  return (
    <div className='container mx-auto y-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='projects'>
        ...
        <div className='overflow-hidden'>
            <div className='flex gap-8 transition-transform duration-500 ease-in-out' style={{transform : `translateX(-${(currentIndex*10)/cardsToShow}%)`}}>
